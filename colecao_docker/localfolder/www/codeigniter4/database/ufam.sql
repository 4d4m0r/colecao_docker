...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20-Jul-2022 às 05:00
...
INSERT INTO `admin` (`id_admin`, `nome_admin`, `senha_admin`) VALUES
(1, 'admin', '202cb962ac59075b964b07152d234b70'),
(6, 'root', '$2y$10$AfMYeoALNjOVPmdeW16WpuVjFooRCL.CFVlEhjxxwWPH2SdOuAhtO'),
(7, 'root', '$2y$10$EZYVLZa818YzBmuXgCOpB.BopxtGYNtlfhLFI6BxcGQ3IyLQUHZiO');
...
INSERT INTO `cidades` (`id_cidades`, `nome_cidades`, `id_estado_cidade`) VALUES
(3, 'Brasiléia', 1),
(4, 'Bujari', 1),
(5, 'Capixaba', 1),
(6, 'Cruzeiro do Sul', 1),
...
CREATE TABLE `cultura` (
  ...
  `id_especie_cultura` int(11) NOT NULL,
  `id_meio_cultura` int(11) NOT NULL,
  `n_dpua_cultura` varchar(45) NOT NULL,
  `codigo_col_ext_cultura` varchar(45) DEFAULT NULL,
  `autor_cultura` varchar(45) DEFAULT NULL,
  `metodo_preservacao_cultura` varchar(45) DEFAULT NULL,
  `cultura_descartada_cultura` varchar(45) DEFAULT NULL,
  `n_cul_preser_oleo_cultura` int(11) DEFAULT NULL,
  `n_cul_preser_agua_cultura` int(11) DEFAULT NULL,
  `data_preser_oleo_cultura` date DEFAULT NULL,
  `data_preser_agua_cultura` date DEFAULT NULL,
  `depositante_cultura` varchar(45) DEFAULT NULL,
  `historico_deposito_cultura` varchar(45) DEFAULT NULL,
  `forma_envio_cultura` varchar(45) DEFAULT NULL,
  `restricao_cultura` tinyint(4) DEFAULT NULL,
  `status_cultura` varchar(45) DEFAULT NULL,
  `observacao_cultura` varchar(3000) DEFAULT NULL,
  `loc_cidade_cultura` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `cultura` (`id_cultura`, `id_especie_cultura`, `id_meio_cultura`, `n_dpua_cultura`, `codigo_col_ext_cultura`, `autor_cultura`, `metodo_preservacao_cultura`, `cultura_descartada_cultura`, `n_cul_preser_oleo_cultura`, `n_cul_preser_agua_cultura`, `data_preser_oleo_cultura`, `data_preser_agua_cultura`, `depositante_cultura`, `historico_deposito_cultura`, `forma_envio_cultura`, `restricao_cultura`, `status_cultura`, `observacao_cultura`, `loc_cidade_cultura`) VALUES
(878, 463, 173, 'DPUA 0001', 'NRRL 3623 e IMT 244', 'Wehmer', 'óleo;água', 'null', 2, 2, '2010-09-01', '2010-08-27', 'null', 'Linhagem solicitada a Micoteca do Prof. Lacaz', 'null', 0, 'null', 'null', 9111),
(879, 464, 173, 'DPUA 0002', 'null', 'null', 'óleo', 'óleo', 2, 0, '1969-12-31', '1969-12-31', 'null', 'Linhagem solicitada ao Lab.de micologia Dpto.', 'null', 0, 'null', 'null', 239),
(880, 465, 173, 'DPUA 0003', 'null', 'null', 'óleo', 'null', 2, 0, '1990-08-16', '1969-12-31', 'null', 'Linhagem solicitada a Micoteca do Prof. Lacaz', 'null', 0, 'null', 'null', 9111),
(881, 466, 173, 'DPUA 0004', 'null', 'null', 'óleo', ' óleo', 2, 0, '1990-08-16', '1969-12-31', 'null', 'Linhagem solicitada ao Lab.de micologia. FUA', 'null', 0, 'null', 'null', 239),
(882, 467, 173, 'DPUA 0005', 'null', 'null', 'óleo', 'óleo', 2, 0, '1990-08-16', '1969-12-31', 'null', 'Linhagem solicitada a Micoteca do Prof. Lacaz', 'null', 0, 'null', 'null', 9111),
(883, 468, 173, 'DPUA 0006', 'NRRL1469 ', 'null', 'óleo', 'null', 2, 0, '1988-03-09', '1969-12-31', 'null', 'Linhagem solicitada a Micoteca do Prof. Lacaz', 'null', 0, 'null', 'null', 9111),
(884, 469, 173, 'DPUA 0007', '1.S.S - HC F.M.U.P', 'null', 'óleo', 'null', 2, 0, '1990-08-16', '1969-12-31', 'null', 'Linhagem solicitada a Micoteca do Prof. Lacaz', 'null', 0, 'null', 'null', 9111),
(885, 470, 173, 'DPUA 0008', 'NRRL 2981', 'null', 'óleo;água', 'null', 2, 2, '2010-05-05', '2010-04-30', 'null', 'Linhagem solicitada a Micoteca do Prof. Lacaz', 'null', 0, 'null', 'null', 9111),
(886, 471, 173, 'DPUA 0009', 'null', 'null', 'óleo', 'null', 2, 0, '1990-08-16', '1969-12-31', 'null', 'Linhagem solicitada a Micoteca do Depto.de Mi', 'null', 0, 'null', 'null', 5141),
(887, 473, 173, 'DPUA 0010', 'NRRL 1392', 'null', 'óleo;água', 'null', 2, 2, '1969-12-31', '1969-12-31', 'null', 'Linhagem solicitada a Micoteca do Prof. Lacaz', 'null', 0, 'null', 'null', 9111);

-- --------------------------------------------------------

--
-- Estrutura stand-in para vista `dados_genero`
-- (Veja abaixo para a view atual)
--
CREATE TABLE `dados_genero` (
`nome_genero` varchar(45)
,`count(nome_genero)` bigint(21)
);
...
CREATE TABLE `especie` (
  ...
  `nome_especie` varchar(45) DEFAULT NULL,
  `status_tax_especie` varchar(45) DEFAULT NULL,
  `tipos_org_especie` varchar(45) DEFAULT NULL,
  `aplicacoes_especie` varchar(45) DEFAULT NULL,
  `procedencia_especie` varchar(45) DEFAULT NULL,
  `substrato_especie` varchar(45) DEFAULT NULL,
  `riscos_especie` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `especie` (`id_especie`, `nome_especie`, `status_tax_especie`, `tipos_org_especie`, `aplicacoes_especie`, `procedencia_especie`, `substrato_especie`, `riscos_especie`) VALUES
(463, 'Mucor hiemalis', 'Mucorales', 'Fungo filamentoso', 'null', 'IMT', 'null', 'null'),
(464, 'Mucor sp', 'null', 'Fungo filamentoso', 'null', 'IMT', 'null', 'null'),
(465, 'Mucor ramosissimus', 'null', 'Fungo filamentoso', 'null', 'IMT', 'null', 'null'),
(466, 'Rhizopus sp.', 'null', 'Fungo filamentoso', 'null', 'IMT', 'null', 'null'),
(467, 'Rhizopus oligosporus', 'null', 'Fungo filamentoso', 'null', 'IMT', 'null', 'null'),
(468, 'Rhizopus arrhizus', 'null', 'Fungo filamentoso', 'null', 'IMT', 'null', 'null'),
(469, 'Rhizopus oryzae', 'null', 'Fungo filamentoso', 'null', 'IMT', 'null', 'null'),
(470, 'Absidia corymbifera', 'null', 'Fungo filamentoso', 'null', 'IMT', 'null', 'null'),
(471, 'Cuninghamella sp', 'null', 'Fungo filamentoso', 'null', 'URM', 'null', 'null'),
(473, 'Cuninghamella elegans', 'null', 'Fungo filamentoso', 'null', 'IMT', 'null', 'null');
...
CREATE TABLE `estados` (
  ...
  `nome_estados` varchar(45) NOT NULL,
  `sigla_estados` varchar(45) NOT NULL,
  `id_pais_estados` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `estados` (`id_estados`, `nome_estados`, `sigla_estados`, `id_pais_estados`) VALUES
(1, 'Acre', 'AC', 33),
(2, 'Alagoas', 'AL', 33),
(3, 'Amazonas', 'AM', 33),
(4, 'Amapá', 'AP', 33),
...
--
-- Estrutura stand-in para vista `genero_especie`
-- (Veja abaixo para a view atual)
--
CREATE TABLE `genero_especie` (
`nome_genero` varchar(45)
...
--
-- Estrutura da tabela `meio_cultivo`
--

CREATE TABLE `meio_cultivo` (
  `id_meio_cultivo` int(11) NOT NULL,
  `meio_cultivo` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Extraindo dados da tabela `meio_cultivo`
--

INSERT INTO `meio_cultivo` (`id_meio_cultivo`, `meio_cultivo`) VALUES
(173, 'SAB');
...
CREATE TABLE `pais` (
  ...
  `nome_pt_pais` varchar(45) NOT NULL,
  `nome_eng_pais` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `pais` (`id_pais`, `nome_pt_pais`, `nome_eng_pais`) VALUES
...
ALTER TABLE `cidades`
  ...
  ADD KEY `fk_id_estado_cidades_idx` (`id_estado_cidade`);
...
ALTER TABLE `cultura`
  ...
  ADD KEY `fk_id_especie_idx` (`id_especie_cultura`),
  ADD KEY `fk_id_meio_idx` (`id_meio_cultura`),
  ADD KEY `fk_id_cidade_idx` (`loc_cidade_cultura`);
...
ALTER TABLE `estados`
  ...
  ADD KEY `fk_id_pais_estados_idx` (`id_pais_estados`);

--
-- Índices para tabela `meio_cultivo`
--
ALTER TABLE `meio_cultivo`
  ADD PRIMARY KEY (`id_meio_cultivo`);
...
--
ALTER TABLE `cidades`
  MODIFY `id_cidades` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9390;

--
-- AUTO_INCREMENT de tabela `cultura`
--
ALTER TABLE `cultura`
  MODIFY `id_cultura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=888;

--
-- AUTO_INCREMENT de tabela `especie`
--
ALTER TABLE `especie`
  MODIFY `id_especie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=474;

--
-- AUTO_INCREMENT de tabela `meio_cultivo`
--
ALTER TABLE `meio_cultivo`
  MODIFY `id_meio_cultivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=197;
COMMIT;
